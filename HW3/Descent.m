%Gradient Descent Algortihm with Fixed Step Size
%%% Inputs:
...
function [final_vector,final_value,iteration]=Descent(func,initial,alpha,end_condition,bound)
    x=initial;
    ...
    if end_condition==1 % First stop condition !
        ...
        x=x_last-alpha*Gradient(func,x_last); % Use gradient algortihm to calculate the next point
