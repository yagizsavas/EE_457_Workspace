...
% using inexact line search methods
...
function [final_vector,final_value,iteration,search_iter]=Inexact_Modified_Newtons_Method(func,initial,search_condition,end_condition,bound)
    x=initial;
